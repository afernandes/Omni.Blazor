...
- **Complete i18n pipeline** — built-in pt-BR/English resources, validated RESX/JSON/database catalogs, optional PO package, real plural rules, global/scoped cultures, RTL and pseudo-locales ([guide](docs/localization.md))
