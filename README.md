...
- **MCP server** (`tools/Omni.Blazor.Mcp`) — live `list_components` / `get_component` / `search_components` tools over the manifest, wired in [`.mcp.json`](.mcp.json). See [AGENTS.md](AGENTS.md#mcp-server-live-tools-for-agents).
