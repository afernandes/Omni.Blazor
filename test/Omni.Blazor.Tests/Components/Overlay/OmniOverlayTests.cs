...
public class OmniOverlayTests : TestContextBase
{
    ...
    {
        var cut = RenderComponent<OmniOverlay>(p => p.Add(c => c.Visible, false));
    ...
    {
        var cut = RenderComponent<OmniOverlay>(p => p.Add(c => c.Visible, true));
    ...
    {
        var cut = RenderComponent<OmniOverlay>(p => p
