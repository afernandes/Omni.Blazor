...
public class OmniThemeTests : TestContextBase
{
    ...
    {
        var cut = Render<OmniTheme>(p => p.Add(c => c.Accent, "emerald"));
    ...
    {
        var cut = Render<OmniTheme>(p => p.Add(c => c.Accent, "neon-pink"));
    ...
    {
        var cut = Render<OmniTheme>(p => p.Add(c => c.Dark, true));
    ...
    {
        var cut = Render<OmniTheme>(p => p.Add(c => c.Dark, false));
