...
public class OmniStatGroupTests : TestContextBase
{
    ...
    {
        var cut = Render<OmniStatGroup>(p => p.Add(c => c.Columns, 3));
    ...
    {
        var cut = Render<OmniStatGroup>(p => p.Add(c => c.Columns, 0));
    ...
    {
        var cut = Render<OmniStatGroup>(p => p
