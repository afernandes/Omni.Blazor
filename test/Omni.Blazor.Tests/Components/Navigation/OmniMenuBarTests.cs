...
public class OmniMenuBarTests : TestContextBase
{
    ...
    {
        var cut = Render<OmniMenuBar>(p => p.Add(c => c.Trigger, trigger));
    ...
    {
        var cut = Render<OmniMenuBar>(p => p
    ...
    {
        var cut = Render<OmniMenuBar>(p => p.Add(c => c.AriaLabel, "Main navigation"));
    ...
    {
        var cut = Render<OmniMenuBar>(p => p.Add(c => c.Class, "custom-mb"));
    ...
    {
        var cut = Render<OmniMenuBar>(p => p.Add(c => c.Style, "background: #fff"));
